...
const RoomByRoomScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>RoomByRoom</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['RoomByRoomScreen'])}>
...
export default RoomByRoomScreen;
