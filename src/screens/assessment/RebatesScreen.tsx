...
const RebatesScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Rebates</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['RebatesScreen'])}>
