...
const HVACSystemScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>HVACSystem</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['HVACSystemScreen'])}>
...
export default HVACSystemScreen;
