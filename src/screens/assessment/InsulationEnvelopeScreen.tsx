...
const InsulationEnvelopeScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>InsulationEnvelope</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['InsulationEnvelopeScreen'])}>
...
export default InsulationEnvelopeScreen;
