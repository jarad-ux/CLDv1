...
const ComfortConcernsScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>ComfortConcerns</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['ComfortConcernsScreen'])}>
...
export default ComfortConcernsScreen;
