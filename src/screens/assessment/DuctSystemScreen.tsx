...
const DuctSystemScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>DuctSystem</Text>
      <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate(nextScreens['DuctSystemScreen'])}>
...
export default DuctSystemScreen;
